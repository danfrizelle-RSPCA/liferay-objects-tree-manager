...
function FlowEditor(props) {
  ...
  const onLayout = useCallback(
    ...
    [nodes, edges, props.nodeService, setNodes, setEdges, fitView]
  );
  ...
  }, [treeId, loadGraphData, wipeGraphData]);
            ...
            <Panel position="" className="center-panel">
              <h1>
                {trees != null && treeId != null
                  ? trees.find((tree) => String(tree.id) === String(treeId))
                      .treeLabel
